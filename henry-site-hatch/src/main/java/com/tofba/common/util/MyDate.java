...
public class MyDate {    
    /**
     * this attribute use the 24 hour format date show year, month, day, hour, minute, second 例如:2014-10-04 16:04:50
     */
    public final String dateTimeFormat = "yyyy-MM-dd HH:mm:ss";  
    public final String dateTimeHourFormat = "yyyy-MM-dd HH:mm";
    /**
     * this attribute use the UTC(Coordinated Universal Time) format date 例如:
     */
    public final String UTCDateTimeFormat = "yyyy-MM-dd'T'HH:mm:ss'Z'";    
    /**
     * this attribute show year, month, day 例如:2014-10-04
     */
    public final String dateFormat = "yyyy-MM-dd";    
    /**
     * this attribute only show year, month 例如:2014-10
     */
    public final String dateShortFormat = "yyyy-MM";    
    /**
     * this attribute only show year, week
     */
    public final String weekFormat = "yyyy-ww";    
    /**
     * this attribute only show year, month
     */
    public String monthFormat = "yyyy-MM";
    /**
     * this attribute only show year
     */
     ...
     */
    public String getLastMonthDateTime() {
        SimpleDateFormat df = new SimpleDateFormat(dateTimeFormat);
        Date date = new Date();
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
     ...
     * @author  Jeff(fba01)
     */
    public static String timeFormatConvert(String dateStr,String oldForMate,String forMate) {

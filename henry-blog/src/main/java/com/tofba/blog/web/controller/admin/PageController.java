...
public class PageController {
    ...
    public String gallery(Model model, @RequestParam(value = "page", defaultValue = "0") Integer page, @RequestParam(value = "size", defaultValue = "18") Integer size) {
    ...
    public String newPage(Model model) {
        List<String> customTpls = SystemUtil.getCustomTpl(BlogConstant.OPTIONS.get(BlogPropertiesEnum.THEME.getProp()));

...
public class PostController extends BaseController {
     ...
     */
    @GetMapping
    public String posts(Model model, @RequestParam(value = "status", defaultValue = "0") Integer status, @RequestParam(value = "page", defaultValue = "0") Integer page, @RequestParam(value = "size", defaultValue = "10") Integer size) {
    ...
    @ResponseBody
    public JsonResult save(@ModelAttribute Post post, @RequestParam("cateList") List<String> cateList, @RequestParam("tagList") String tagList, HttpSession session) {
    ...
    @ResponseBody
    public JsonResult update(@ModelAttribute Post post, @RequestParam("cateList") List<String> cateList, @RequestParam("tagList") String tagList) {
        // old data
    ...
    public JsonResult pushAllToBaidu(@RequestParam("baiduToken") String baiduToken) {
        ...
        String blogUrl = BlogConstant.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp());
        ...
        String result = SystemUtil.baiduPost(blogUrl, baiduToken, urls.toString());

...
public class ApiMetaWeBlog {
     ...
     * @throws Exception
     */
    private Post parsetPost(final JSONObject methodCall)
        throws Exception {
    ...
    private String getUserBlogs() {
        final StrBuilder strBuilder = new StrBuilder("<?xml version=\"1.0\" encoding=\"UTF-8\"?><methodResponse><params><param><value><array><data><value><struct>");
    ...
    private String buildBlogInfo() {
        final String blogId = BlogConstant.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp());
        final String blogTitle = BlogConstant.OPTIONS.get(BlogPropertiesEnum.BLOG_TITLE.getProp());
        ...
        strBuilder.append(BlogConstant.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()));
        strBuilder.append("</value></member>");
    ...
    private String getCategories()
        throws Exception {
        final StrBuilder strBuilder = new StrBuilder("<?xml version=\"1.0\" encoding=\"UTF-8\"?><methodResponse><params><param><value><array><data>");
    ...
    private String buildCategories()
        ...
        for (Category category : categories) {
            ...
            strBuilder.append("<member><name>htmlUrl</name>").append("<value>").append(BlogConstant.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp())).append("/categories/").append(cateName).append("</value></member>");

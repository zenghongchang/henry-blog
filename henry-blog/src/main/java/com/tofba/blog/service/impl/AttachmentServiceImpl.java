...
import com.tofba.blog.model.dto.QiNiuPutSet;
import com.tofba.blog.model.enums.AttachLocationEnum;
import com.tofba.blog.model.enums.BlogPropertiesEnum;
import com.tofba.blog.repository.AttachmentRepository;
import com.tofba.blog.service.AttachmentService;
import com.tofba.blog.utils.SystemUtil;
import com.tofba.blog.utils.MD5;
...
public class AttachmentServiceImpl implements AttachmentService {
    ...
    public Map<String, String> upload(MultipartFile file, HttpServletRequest request) {
        ...
        String attachLoc = BlogConstant.OPTIONS.get(BlogPropertiesEnum.ATTACH_LOC.getProp());
    ...
    public Map<String, String> attachUpload(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            String size = SystemUtil.parseSize(new File(fullPath.toString()).length());
            String wh = SystemUtil.getImageWh(new File(fullPath.toString()));
    ...
    public Map<String, String> attachQiNiuUpload(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            String key = MD5.getMD5Checksum(file);
            String accessKey = BlogConstant.OPTIONS.get("qiniu_access_key");
            String secretKey = BlogConstant.OPTIONS.get("qiniu_secret_key");
            String domain = BlogConstant.OPTIONS.get("qiniu_domain");
            String bucket = BlogConstant.OPTIONS.get("qiniu_bucket");
            String smallUrl = BlogConstant.OPTIONS.get("qiniu_small_url");
            ...
            resultMap.put("size", SystemUtil.parseSize(file.getSize()));
    ...
    public Map<String, String> attachUpYunUpload(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            String key = MD5.getMD5Checksum(file);
            String ossSrc = BlogConstant.OPTIONS.get("upyun_oss_src");
            String ossPwd = BlogConstant.OPTIONS.get("upyun_oss_pwd");
            String bucket = BlogConstant.OPTIONS.get("upyun_oss_bucket");
            String domain = BlogConstant.OPTIONS.get("upyun_oss_domain");
            String operator = BlogConstant.OPTIONS.get("upyun_oss_operator");
            String smallUrl = BlogConstant.OPTIONS.get("upyun_oss_small");

package com.tofba.blog.listener;
...
public class StartedListener implements ApplicationListener<ApplicationStartedEvent> {
    ...
    public void onApplicationEvent(ApplicationStartedEvent event) {
        ...
        // 启动定时任务
        CronUtil.start();
        LOGGER.info("The scheduled task starts successfully!");
    }
    ...
    private void loadActiveTheme()
        ...
        if (StringUtils.isNotBlank(themeValue)) {
    ...
    private void loadThemes() {
        ...
        List<Theme> themes = SystemUtil.getThemes();
        if (null != themes) {
            BlogConstant.THEMES = themes;
        }
    }
    ...
    private void loadOwo() {
        Map<String, String> map = new HashMap<String, String>(135);

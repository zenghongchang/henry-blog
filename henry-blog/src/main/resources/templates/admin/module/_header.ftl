<header class="main-header">
    <a href="/admin" class="logo">
        <span class="logo-mini"><b>九方</b></span>
        <span class="logo-lg"><b>九方论坛</b></span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<#if user.userAvatar?if_exists!="">${user.userAvatar}<#else >/static/halo-backend/images/9f61728e5cac70480bbe663ab4c40ae.jpg</#if>" class="user-image" alt="User Image">
                        <span class="hidden-xs">${user.userDisplayName!}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="<#if user.userAvatar?if_exists!="">${user.userAvatar}<#else >/static/halo-backend/images/9f61728e5cac70480bbe663ab4c40ae.jpg</#if>" class="img-circle" alt="User Image">
